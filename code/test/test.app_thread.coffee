...
(function() {
  ...
  ch_text = [
    ...
    ' </b>忍法帖【Lv=11,xxxPT】<b> <>sage<>2011/04/04(月) 10:24:46.33 ID:abc0DEFG1<> <a href="../test/read.cgi/operate/1000000010/1" target="_blank">&gt;&gt;1</a> <br> 乙 <br> てすとてすと試験てすと <>',
  ...
  ch_expected = {
    ...
    res: [
      ...
      },
      {
        ...
        mail: 'sage',
        message: ' <a href="../test/read.cgi/operate/1000000010/1" target="_blank">&gt;&gt;1</a> <br> 乙 <br> てすとてすと試験てすと ',
