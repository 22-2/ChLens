(function () {
  ...
  const getMoveSec = function () {
    ...
    return (m != null ? m[1] : undefined) != null
      ? m != null
        ? m[1]
        : undefined
      : sec;
  ...
  var getJumpUrl = function () {
    ...
    if (
      ...
      return ($meta != null ? $meta.content : undefined) != null
        ? $meta != null
          ? $meta.content
          : undefined
        : "";
    ...
    if (domain.endsWith("2ch.sc")) {
      ...
      return __guard__(as != null ? as[0] : undefined, (x) => x.href) != null
        ? __guard__(as != null ? as[0] : undefined, (x) => x.href)
        : "";
    }
    return "";
  };
  ...
  const main = function () {
    ...
    if (
      ...
      new RegExp(`^https?://(?:\\w+\\.)?machi\\.to/bbs/write\\.cgi`).test(url)
    ) {
      ...
      new RegExp(`^https?://\\w+\\.open2ch\\.net/test/bbs\\.cgi`).test(url)
    ) {
      ...
      new RegExp(`^https?://\\w+\\.\\w+\\.\\w+/test/bbs\\.cgi`).test(url)
    ) {
      if (title.includes("書きこみました")) {
        sendMessageSuccess(getMoveSec() * 1000);
