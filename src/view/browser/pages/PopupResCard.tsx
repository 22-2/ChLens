...
import { decodeResponseHtml } from "./utils";
...
export const PopupResCard: React.FC<StaticResCardProps> = React.memo(
  ({
    res, messageProtocol, anchorPreviewDepth, onUrlClick, onAnchorClick, onAnchorHover, onAnchorLeave, onContextMenu,
  }) => {
...
PopupResCard.displayName = "PopupResCard";export interface StaticResCardProps {
  res: IRes;
