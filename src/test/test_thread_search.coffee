...
<dt><a href="http://__dummyserver3.2ch.net/test/read.cgi/__dummyboard3/1000000010/1-100">ダミースレッド3 テスト</a> (123) - <font size=-1><a href=http://__dummyserver3.2ch.net/__dummyboard3/>ダミー板3</a>＠2ch</font></dt><dd><table border=0 cellpadding=0 cellspacing=0><tr><td class="r_sec_body">…テスト テストテストテストテストテストテストテスト テストテストテストテストテストテストテストテストテストテスト テストテストテストテストテストテストテスト テストテストテストテストテストテストテスト…<br /> <font size=-1><font color=#228822>最新:2012/04/19 12:16</font></font> <a href="?TYPE=TITLE&COUNT=10&STR=%A5%C6%A5%B9%A5%C8+board%3A%A5%CF%A1%BC%A5%C9%A1%A6%B6%C8%B3%A6"><font color=gray>板内</font></a> <a href="?TYPE=TITLE&COUNT=10&STR=%A5%C6%A5%B9%A5%C8+-board%3A%A5%CF%A1%BC%A5%C9%A1%A6%B6%C8%B3%A6"><font color=gray>他の板</font></a> <a href="?TYPE=TITLE&COUNT=10&STR=%A5%C6%A5%B9%A5%C8+host%3A__dummyserver3.2ch.net"><font color=gray>同じサーバ</font></a> <a href="index.php?TYPE=BODY&COUNT=10&STR=1000000010"><font color=gray>スレへのリンク</font></a> <font size=-1><a href="http://p2.2ch.net/p2/index.php?&url=http://__dummyserver3.2ch.net/test/read.cgi/__dummyboard3/1000000010/1-100"><font color=gray>p2</font></a>で<a href="http://p2.2ch.net/p2/index.php?word=%83e%83X%83g&url=http://__dummyserver3.2ch.net/test/read.cgi/__dummyboard3/1000000010/1-100"><font color=gray>抽出</font></a></font> <font size=-1><a href="index.php?TYPE=TITLE&STR=similar:__dummyboard3/1000000010"><font color=gray>類似スレ</font></a></font></td></tr></table></dd>
  ...
  app.module null, ["thread_search"], (ThreadSearch) ->
    ...
    search.read().pipe (result) ->
      ...
      deepEqual(result, [
        {
          url: "http://__dummyserver.2ch.net/test/read.cgi/__dummyboard/1000000010/"
          title: "ダミースレッド&テスト"
          res_count: 12
          created_at: 1000000010000
    ...
    .done (result) ->
      deepEqual(result, [
        ...
        {
          url: "http://__dummyserver3.2ch.net/test/read.cgi/__dummyboard3/1000000010/"
          title: "ダミースレッド3 テスト"
          res_count: 123
          created_at: 1000000010000
