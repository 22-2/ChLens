describe "app.Bookmark", ->
  describe ".legacyToCurrent", ->
    it "LegacyEntryをEntryに変換する", ->
      ...
      # スレブックマーク
      expect(app.Bookmark.legacyToCurrent(
        url: "http://__dummy_server.2ch.net/test/read.cgi/__dummy_board/1000000010/"
        type: "thread"
        bbs_type: "2ch"
        title: "dummy"
        res_count: null
  ...
  describe "EntryList", ->
    ...
    beforeEach ->
      ...
      entry.thread0 =
        url: "http://__dummy.2ch.net/test/read.cgi/dummy/1000000010/"
        type: "thread"
        bbsType: "2ch"
        title: "dummy"
        resCount: 123
      ...
      entry.thread2 =
        url: "http://__dummyserver.2ch.net/test/read.cgi/dummyboard/1000000010/"
        type: "thread"
        bbsType: "2ch"
        title: "dummy2"
        resCount: 123
    ...
    beforeEach ->
      dummyEntry =
        ...
        board1:
          ...
          expired: false
        thread0:
          url: "http://__dummy.2ch.net/test/read.cgi/dummy0/1000000010/"
          type: "thread"
          bbsType: "2ch"
          title: "dummythread0"
          resCount: 123
          ...
          expired: false
        thread1:
          url: "http://__dummy.2ch.net/test/read.cgi/dummy1/1000000010/"
          type: "thread"
          bbsType: "2ch"
          title: "dummythread1"
          resCount: 222
