...
asyncTest "detected_ch_server_moveメッセージを受信すると、板やスレのブックマークを移転に対応して変更する", 8, ->
  ...
  before_thread_url = "http://__dummy_before.2ch.net/test/read.cgi/dummy/1000000010/#res_count=123"
  thread_title = "ダミースレ"
  before_thread_expect_bookmark =
    ...
    read_state: null
    expired: false
  after_thread_url = "http://__dummy_after.2ch.net/test/read.cgi/dummy/1000000010/"
