      ...
      db.transaction(
        (transaction) ->
          ...
          transaction.executeSql(
            "INSERT INTO EntryList values(?, ?, ?, ?, ?, ?, ?, ?, ?)"
            [
              "http://__dummy.2ch.net/test/read.cgi/dummy0/1000000010/",
              "dummyThread0",
              "thread",
              "2ch",
              123,
  ...
  describe "::loadFromDB", ->
    it "DBからデータを読み取る", ->
      ...
      runs ->
        ...
        expect(wsel.get("http://__dummy.2ch.net/test/read.cgi/dummy0/1000000010/")).toEqual
  ...
  describe "::deleteFromDB", ->
    it "DBからEntryを削除する", ->
      ...
      runs ->
        ...
        wsel.deleteFromDB("http://__dummy.2ch.net/test/read.cgi/dummy0/1000000010/", deleteCallback2)
        return
