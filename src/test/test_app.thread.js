...
test("スレのURLから、データのパスと文字コードを返す", 5, function(){
  deepEqual(
    app.thread._get_xhr_info("http://qb5.2ch.net/test/read.cgi/operate/1000000010/"), {
      path: "http://qb5.2ch.net/operate/dat/1000000010.dat",
      charset: "Shift_JIS"
    }, "2ch"
  );
...
test("解釈できない文字列が渡された場合、nullを返す", 4, function(){
...
test("2chのスレをパース出来る", 1, function(){
  var url = "http://qb5.2ch.net/test/read.cgi/operate/1000000010/";
  var text = '\
ﾉtasukeruyo </b>忍法帖【Lv=10,xxxPT】<b> </b>◆0a./bc.def <b><><>2011/04/04(月) 10:19:46.92 ID:abcdEfGH0 BE:1000000010-2BP(1)<> テスト。 <br> http://qb5.2ch.net/test/read.cgi/operate/132452341234/1 <br> <hr><font color="blue">Monazilla/1.00 (V2C/2.5.1)</font> <>[test] テスト 123 [ﾃｽﾄ]\n\
 </b>【東電 84.2 %】<b>  </b>◆0a./bc.def <b><>sage<>2011/04/04(月) 10:21:08.27 ID:abcdEfGH0<> てすとてすとテスト! <>\n\
 </b>忍法帖【Lv=11,xxxPT】<b> <>sage<>2011/04/04(月) 10:24:46.33 ID:abc0DEFG1<> <a href="../test/read.cgi/operate/1000000010/1" target="_blank">&gt&gt1</a> <br> 乙 <br> てすとてすと試験てすと <>\n\
    ...
    res: [
      {
        ...
        other: "2011/04/04(月) 10:19:46.92 ID:abcdEfGH0 BE:1000000010-2BP(1)"
      },
      {
      ...
      },
      {
        ...
        mail: "sage",
        message: ' <a href="../test/read.cgi/operate/1000000010/1" target="_blank">&gt&gt1</a> <br> 乙 <br> てすとてすと試験てすと ',
...
test("まちBBSのスレをパース出来る", 1, function(){
  //削除時の挙動確認用に>>3-4を削除
  //メール欄の確認用に>>5を改変
  var url = "http://www.machi.to/bbs/read.cgi/tawara/511234524356/";
  var text = '\
...
test("したらばのスレをパース出来る", 1, function(){
  //削除時の挙動確認用に>>3-4を削除
  var url = "http://jbbs.livedoor.jp/bbs/read.cgi/computer/42710/1290070091/";
  var text = '\
...
test("したらばのスレをパース出来る(削除系確認)", 1, function(){
  var url = "http://jbbs.livedoor.jp/bbs/read.cgi/computer/42710/1310968239/";
  var text = '\
